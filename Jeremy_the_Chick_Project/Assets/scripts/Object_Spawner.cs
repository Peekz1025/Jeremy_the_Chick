...
public class Object_Spawner : MonoBehaviour
{
    ...
    public void SpawnFire(World_Piece worldPiece, Vector3 jeremyPosition)
    {
        if (jeremyPosition.x >= 250 && jeremyPosition.x < 1500 && Random.value <= .3)
        {
            ...
            PlaceFire(worldPiece, jeremyPosition);
        }
    ...
    public void PlaceFire(World_Piece worldPiece, Vector3 jeremyPosition)
    {
        ...
        if (worldPiece.name == "ground_3(Clone)")
        {
            ...
            {
                Debug.Log(nums[0]);
                Vector3 fireLocation1 = new Vector3(Random.Range(left.x + 0.5f, left.x + 2.5f), left.y + 0.91f, 0f);
            ...
            {
                Debug.Log(nums[2]);
                Vector3 fireLocation3 = new Vector3(Random.Range(left.x + 8.5f, right.x - 0.5f), left.y + 0.91f, 0f);
        ...
        if (worldPiece.name == "ground_4(Clone)")
        {
            ...
            {
                Vector3 fireLocation = new Vector3(Random.Range(left.x + 0.5f, right.x - 0.5f), left.y + 0.91f, 0f);
        ...
        if (worldPiece.name == "ground_5(Clone)")
        {
            ...
            {
                Debug.Log(nums[0]);
                Vector3 fireLocation1 = new Vector3(Random.Range(left.x + 0.5f, left.x + 4.5f), left.y + 0.91f, 0f);
                Instantiate(fire, fireLocation1, Quaternion.identity);
            }
            if (Random.Range(0, 100) <= nums[1])
            {
                Debug.Log(nums[1]);
                Vector3 fireLocation2 = new Vector3(Random.Range(left.x + 7.5f, right.x - 0.5f), left.y + 0.91f, 0f);
                Instantiate(fire, fireLocation2, Quaternion.identity);
            }
        }
        ...
        if (worldPiece.name == "ground_6(Clone)")
        {
            ...
            {
                Debug.Log(nums[0]);
                Vector3 fireLocation1 = new Vector3(Random.Range(left.x + 0.5f, left.x + 3.5f), left.y + 0.91f, 0f);
                Instantiate(fire, fireLocation1, Quaternion.identity);
            }
            if (Random.Range(0, 100) <= nums[1])
            {
        ...
        if (worldPiece.name == "ground_7(Clone)")
        {
            ...
            {
                Debug.Log(nums[2]);
                Vector3 fireLocation3 = new Vector3(Random.Range(left.x + 14.5f, right.x - 0.5f), left.y + 0.91f, 0f);
                Instantiate(fire, fireLocation3, Quaternion.identity);
            }
        }
        ...
        if (worldPiece.name == "ground_8(Clone)")
        {
            ...
            {
                Debug.Log(nums[3]);
                Vector3 fireLocation4 = new Vector3(Random.Range(left.x + 20.5f, right.x - 0.5f), left.y + 0.91f, 0f);
